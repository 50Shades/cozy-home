...
module.exports = __webpack_require__.p + "/img/icon-add-from-store.svg";
...
var _StoreTile = __webpack_require__("./src/components/StoreTile.jsx");
...
var BarCenter = __webpack_provided_cozy_dot_bar.BarCenter;
  ...
  _createClass(Services, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          breakpoints = _props$breakpoints === undefined ? {} : _props$breakpoints;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'col-content col-top-bar', 'data-tutorial': 'top-bar' },
        ...
        _react2.default.createElement(
          ...
          hasConnections ? _react2.default.createElement(
            ...
            _react2.default.createElement(_StoreTile2.default, { label: t('add_service') })
          ) : _react2.default.createElement(
            'div',
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps)((0, _I18n.translate)()((0, _withBreakpoints2.default)()(Services))));
...
var StoreTile = exports.StoreTile = function (_Component) {
  _inherits(StoreTile, _Component);

  function StoreTile(props) {
    _classCallCheck(this, StoreTile);

    var _this = _possibleConstructorReturn(this, (StoreTile.__proto__ || Object.getPrototypeOf(StoreTile)).call(this, props));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', {
            className: 'item-icon',
            src: __webpack_require__("./src/assets/images/icon-add-from-store.svg")
          })
        ),
        _react2.default.createElement(
          _Button.Button,
      ...
      return _react2.default.createElement(
        ...
        isReady && _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, {
            path: '/connected',
            render: function render(props) {
              return _react2.default.createElement(_Services2.default, {
                base: '/connected',
                wrapper: _this2.contentWrapper
              });
            }
          }),
...
//# sourceMappingURL=0.a3df936e9ff16f22b58e.hot-update.js.map