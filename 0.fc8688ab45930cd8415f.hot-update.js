...
function display(t) {
  var appsPanel = !!document.querySelectorAll('[data-tutorial=apps]')[0];
  var servicesPanel = !!document.querySelectorAll('[data-tutorial=services]')[0];

  for (var element in [appsPannel, servicesPanel]) {
    throw new Error('Missing tutorial element.');
  }
  ...
  tutorial.setOptions({
    ...
    steps: [{
      ...
      element: servicesPanel ? document.querySelectorAll('[data-tutorial=empty-view]')[0] : document.querySelectorAll('[data-tutorial=add-service]')[0],
...
//# sourceMappingURL=0.fc8688ab45930cd8415f.hot-update.js.map