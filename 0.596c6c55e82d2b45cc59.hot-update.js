...
function display(t) {
  ...
  tutorial.setOptions({
    ...
    steps: [{
      element: appsPanel,
      intro: '<h1>' + t('tutorial.home_apps.title') + '</h1><div>' + t('tutorial.menu_apps.text') + '</div>',
      tooltipClass: 'tooltipApps',
      position: 'bottom'
    }, {
      element: servicesPanel,
      intro: '<h1>' + t('tutorial.home.services.title') + '</h1><div>' + t('tutorial.cozy_collect.text') + '</div>',
...
//# sourceMappingURL=0.596c6c55e82d2b45cc59.hot-update.js.map