...
/***/ "./src/assets/sprites/icon-forbidden.svg":
...
exports.isConnectionRunning = exports.isConnectionEnqueued = exports.isConnectionDeleting = exports.isConnectionConnected = exports.isCreatingConnection = exports.getTriggerLastSuccess = exports.getTriggerIdByKonnectorAndAccount = exports.getTriggerAccount = exports.getCreatedAccount = exports.getConnectionError = exports.getQueue = exports.getConnectionsByKonnector = exports.hasAtLeastOneTriggerWithUserError = exports.hasAtLeastOneTriggerWithError = exports.launchTriggerAndQueue = exports.deleteConnection = exports.endConnectionCreation = exports.startConnectionCreation = exports.updateConnectionError = exports.purgeQueue = exports.enqueueConnection = exports.createConnection = exports.END_CONNECTION_CREATION = exports.START_CONNECTION_CREATION = exports.UPDATE_CONNECTION_ERROR = exports.UPDATE_CONNECTION_RUNNING_STATUS = exports.RECEIVE_NEW_DOCUMENT = exports.RECEIVE_DATA = exports.PURGE_QUEUE = exports.LAUNCH_TRIGGER = exports.ENQUEUE_CONNECTION = exports.DELETE_CONNECTION = exports.CONNECTION_DELETED = exports.CREATE_CONNECTION = exports.DEFAULT_QUEUE_DELAY = undefined;
...
// Helpers
var hasAtLeastOneTriggerWithError = exports.hasAtLeastOneTriggerWithError = function hasAtLeastOneTriggerWithError(state, konnectorSlug) {
  return !!state.konnectors && !!state.konnectors[konnectorSlug] && !!state.konnectors[konnectorSlug].triggers && !!Object.values(state.konnectors[konnectorSlug].triggers).find(function (trigger) {
    return !!trigger.error;
  });
};

var hasAtLeastOneTriggerWithUserError = exports.hasAtLeastOneTriggerWithUserError = function hasAtLeastOneTriggerWithUserError(state, konnectorSlug) {
  return !!state.konnectors && !!state.konnectors[konnectorSlug] && !!state.konnectors[konnectorSlug].triggers && !!Object.values(state.konnectors[konnectorSlug].triggers).find(function (trigger) {
    return !!trigger.error && (0, _konnectors.isKonnectorUserError)(trigger.error);
  });
};
...
exports.getKonnectorMessage = exports.getMostAccurateErrorKey = exports.KONNECTOR_RESULT_STATE = exports.KONNECTORS_DOCTYPE = exports.ERROR_TYPES = undefined;
exports.subscribeAll = subscribeAll;
exports.addFolderPermission = addFolderPermission;
exports.isKonnectorLoginError = isKonnectorLoginError;
exports.isKonnectorUserError = isKonnectorUserError;
exports.isKonnectorKnownError = isKonnectorKnownError;
exports.buildKonnectorError = buildKonnectorError;

var _realtime = __webpack_require__("./src/lib/realtime.js");
...
var KONNECTOR_RESULT_STATE = exports.KONNECTOR_RESULT_STATE = {
  ERRORED: 'errored',
  CONNECTED: 'done'
};
...
function patchFolderPermission(cozy, konnector) {
  ...
  var saveFolder = folderId ? { type: 'io.cozy.files', values: [folderId] } : {};
...
function isKonnectorUserError(error) {
  return error && error.type && [ERROR_TYPES.LOGIN_FAILED, ERROR_TYPES.USER_ACTION_NEEDED].includes(error.type);
}
...
var getMostAccurateErrorKey = exports.getMostAccurateErrorKey = function getMostAccurateErrorKey(t, error) {
...
var getKonnectorMessage = exports.getKonnectorMessage = function getKonnectorMessage(t, konnector, message) {
...
var _IntentHandler = __webpack_require__("./src/containers/IntentHandler.jsx");

var _IntentHandler2 = _interopRequireDefault(_IntentHandler);

__webpack_require__("./src/styles/services.styl");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // store
  var store = (0, _configureStore2.default)(client, context, { lang: lang });
  ...
  (0, _reactDom.render)(_react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_IntentHandler2.default, { appData: appData })
      )
    )
...
//# sourceMappingURL=1.f679e56cb9bdb8861c4e.hot-update.js.map